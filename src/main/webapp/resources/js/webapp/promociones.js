...
var templatesPromo = new Array("promo6","promo8","promo1","promo5", "promo4", "promo7", "promo2", "promo3"); //, "promo6");
var nombresPromo = new Array("Cursos","Navidad","Buen Fin","Floral", "Tecnología 2", "Bares", "Hipster", "Tecnología"); //, "ATT"); /*Cambiar nombres*/
