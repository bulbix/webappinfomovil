...
var templatesPromo = new Array("promo5", "promo4", "promo1", "promo2", "promo3"); //, "promo6");
var nombresPromo = new Array("Floral", "Tecnología 2", "Bares", "Hipster", "Tecnología"); //, "ATT"); /*Cambiar nombres*/
