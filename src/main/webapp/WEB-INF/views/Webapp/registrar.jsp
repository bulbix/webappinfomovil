...
<nav class="navbar navbar-inverse navbar-static-top">
    ...
    <div id="navbar" class="navbar-collapse collapse text-right">
        ...
        <li><a href="#" class="smoothScroll">Iniciar sesiÛn</a></li>
        <li class="active"><a href="#" class="smoothScroll">RegÌstrate</a></li>
      </ul>
        </div>
    <!--/.nav-collapse --> 
  </div>
...
<div class="theme-showcaseApp" role="main" id="intro"> 
    ...
    <div class="container">
        ...
        <div class="form-group col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
            ...
            <label class="control-label"></label>
            <div class="controls">
                  <input type="password" class="form-control" placeholder="ContraseÒa" required="required" name="passField" />
                  <p class="help-block"></p>
                </div>
          </div>
            </div>
        ...
        <div class="form-group col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
            ...
            <label class="control-label"></label>
            <div class="controls">
                  <input type="password" class="form-control" placeholder="ContraseÒa" required="required" data-validation-match-match="passField" />
                  <p class="help-block"></p>
                </div>
          </div>
            </div>
        ...
        <div class="form-group col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
            ...
            <label class="control-label"></label>
            <div class="controls">
                  <input type="text" class="form-control" placeholder="CÛdigo de promociÛn" required="required" value = "${ codigo }"/>
                  <p class="help-block"></p>
                </div>
          </div>
            </div>
...
<footer class="footer">
    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 ">
              <p class="helpMx txtWhite reset text-center"><em>Ayudando a construir una economÌa digital.</em></p>
            </div>
