...
<li> <a href="#" onclick="cambiarIdioma();return false;"><img src=<c:url value="/resources/webapp/images/fa-lang${ extensionImg }.png"/> width="20" height="20" alt="Infomovil" class="animated fadeIn ${colorTexto}"/><spring:message code="idioma"/></a></li>
