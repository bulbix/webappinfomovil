...
<!--[if lt IE 8]>
      ...
      <script src=" resources/webapp/<c:url value="/resources/webapp/js/respond.min.js"></script>
    <![endif]-->
<!-- Bootstrap core CSS -->
    ...
    <div class="container header" >
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
          ...
          <p> <img src="<c:url value="/resources/webapp/images/fa-warning.png"/>" width="30" height="30" alt="Alerta" /></p>
          <p><strong>El formato de la URL no es el correcto</strong></p>
          <div style="height:30%; display:block; width:100%; min-height:70px;"></div>
        </div>
      </div>
    </div>
