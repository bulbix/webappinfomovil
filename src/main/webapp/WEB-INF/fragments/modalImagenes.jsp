...
<div class="modal-body">  
	<div id="galeriaVacia">
    	<p class="textBlack text-center" style="display:block; min-height:150px; margin: 50px 0 0 0;"><img width="30" height="30" alt="Infomovil" src="<c:url value="/resources/webapp/images/ico_img-bk.png"/>" />  Agrega imágenes</p>
    </div>
    ...
    <div id="facebookDiv">
        ...
        <div id="terceroFB">
            ...
            <form action="">
                ...
                <button type="button" class="btn btn-purple"  id="btnGuardarImagen" onclick="guardarImagenesJQF()">Guardar</button>
            </form>
