			...
			<div class="row">
					...
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" style="text-transform:lowercase;" class="form-control textBlack text-center"
								...
								placeholder="Escribe aquí" maxlength="30" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe aquí'" autocomplete="off"/>
		        ...
		        <div class="col-xs-12 col-sm-12 text-center textBlack reset" >			
		          ...
		          <div class="col-xs-12 col-sm-12 col-md-6 col-md-offset-3 col-lg-6 col-lg-offset-3">
		            <div class="divider "></div>
		            <input type="text" placeholder="Escribe aquí" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Escribe aquí'" maxlength="30" 
