...
<div class="modal-content btnsEditor">
	<div class="modal-header">
		...
		<p class="modal-title textBlack"><strong>Vista Previa</strong></p>
...
<iframe src="http://promo.mobileinfo.io/tmp/3666-P2015-10-1-13-9-ljhv.html" style="width:100%; min-height:200px; border:none; overflow-y:scroll" frame-border="0"></iframe>	
