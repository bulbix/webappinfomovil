...
<div class="modal-content btnsEditor">
	<div class="modal-header">
		...
		<p class="modal-title textBlack"><strong></strong></p>
...
<!-- 		</button> -->
	...
	<h2 class="textPurple col-xs-12 col-sm-12 col-md-12 col-lg-12 text-center">&iexcl;Felicidades, ya publicaste tu primera promoción!</h2>
