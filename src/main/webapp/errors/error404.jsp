...
<meta name="description" content="Infomovil. Nunca antes ha sido tan f&aacute;cil crear una p&aacute;gina web. Con Infomovil crea tu p&aacute;gina web f&aacute;cil, r&aacute;pido y gratuitamente en 5 minutos."/>
...
<meta property="og:description" content="Infomovil. Nunca antes ha sido tan f&aacute;cil crear una p&aacute;gina web. Con Infomovil crea tu p&aacute;gina web f&aacute;cil, r&aacute;pido y gratuitamente en 5 minutos." />
<meta property="og:image" content="<c:url value="/resources/webapp/images/apple-touch-icon-57x57.png"/>"/>
<meta property="og:url" content="http://www.infomovil.com" />
<meta itemprop="name" content="Infomovil"/>
<meta itemprop="description" content="Infomovil. Nunca antes ha sido tan f&aacute;cil crear una p&aacute;gina web. Con Infomovil crea tu p&aacute;gina web f&aacute;cil, r&aacute;pido y gratuitamente en 5 minutos. P&acute;gina web creado con www.infomovil.com"/>
...
<body role="document" data-spy="scroll" data-target=".navbar" data-offset="75" id="page-top" class="bodyErr">
...
<nav class="navbar navbar-inverse navbar-static-top">
  <div class="container">
    <div class="navbar-header">
      ...
      <img width="50" height="50" alt="Infomovil" src="<c:url value="/resources/webapp/images/apple-touch-icon-57x57.png"/>"/> </span><span class="marLeft">Editor de sitios <span class="hidden-xs">Infomovil</span></span></a> </div>
...
<div class="headerBg">
    ...
    <div class="container header" >
      <div class="row">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
          ...
          <!-- <p class="text-center"> <img src="<c:url value="/resources/webapp/images/fa-warning.png"/>" width="30" height="30" alt="Alerta" /></p> -->
           <h2 class="textBlack text-center">El recurso solicitado no está disponible. [404]
             </h2>
  ...
  <div class="container">
                    <div class="col-xs-12" >
                  <div class="col-xs-12 col-md-4 col-md-offset-4"> <img src="http://www.infomovil.com/templates/Index/images/logo_infomovil.png" alt="Infomovil" onerror="this.src='http://www.infomovil.com/templates/Index/images/trans.png';" class="img-responsive" style="min-width:210px; max-width:215px; text-align:center; margin:0 auto;"/> <span > </span> </div>
                  <div class="col-xs-12 resetAll">
                        <p class="text-center">Descarga la app de Infomovil. Es gratis.</p>
                      </div>
                  <div class="col-xs-6 col-md-2 col-md-offset-4"> <a href="https://itunes.apple.com/mx/app/infomovil/id898313250?mt=8" target="blank"> <img src="http://www.infomovil.com/templates/Index/images/icn_appstore.png"  alt="app store" onerror="this.src='http://www.infomovil.com/templates/Index/images/trans.png';" class="img-responsive" style="max-width:200px; min-width:100px; text-align:center; margin:0 auto; width:100%"/> </a> </div>
                  <div class="col-xs-6 col-md-2 "> <a itemprop="downloadUrl"  href="https://play.google.com/store/apps/details?id=com.infomovil.infomovil" target="blank"> <img src="http://www.infomovil.com/templates/Index/images/icn_gstore.png"  alt="google store"   onerror="this.src='http://www.infomovil.com/templates/Index/images/trans.png';" class="img-responsive" style="max-width:200px; min-width:100px; text-align:center; margin:0 auto; width:100%"/> </a> </div>
                </div>
                  </div>
...
<script src="<c:url value="/resources/js/jquery-ui-1.10.4/jquery-1.10.2.js"/>"></script>
